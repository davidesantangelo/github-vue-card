<template>
  <div class="user">
     <a v-bind:href="response.html_url" class="flex flex-col bg-orange-100 border-t-4 border-orange-500 text-orange-700 p-4">
      <div class="text-center py-2 lg:px-4">
        <div class="items-center text-orange-500 leading-none flex lg:inline-flex" role="alert">
          <span class="font-semibold mr-2 text-left flex-auto">Visit the Awesome <span class="underline">Davide Santagelo</span> GitHub Profile </span>
    ...
    <div class="flex mt-20">
      ...
      <div class="w-3/5 bg-gray-400 h-16 mx-auto">
        ...
        <div class="w-2 bg-gray-800"></div>
          ...
          <div class="flex">
            <div class="w-1/6 bg-orange-400 h-10"></div>
            <div class="w-1/6 bg-orange-500 h-10"></div>
            <div class="w-1/6 bg-orange-400 h-10"></div>
            <div class="w-1/6 bg-orange-500 h-10"></div>
            <div class="w-1/6 bg-orange-400 h-10"></div>
            <div class="w-1/6 bg-orange-500 h-10"></div>
